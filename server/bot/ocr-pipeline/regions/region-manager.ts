    ...
    const defaultTemplates: RegionTemplate[] = [
      {
        name: 'hero_cards',
        type: 'cards',
        relativeBounds: { xPercent: 0.42, yPercent: 0.75, widthPercent: 0.16, heightPercent: 0.12 },
        priority: 100,
      ...
      },
      {
        ...
        relativeBounds: { xPercent: 0.28, yPercent: 0.40, widthPercent: 0.44, heightPercent: 0.10 },
        priority: 95,
        processingHints: { expectedCharset: 'cards', minConfidence: 0.8 },
      },
      {
      ...
      },
      {
        name: 'action_buttons',
        type: 'action_buttons',
        relativeBounds: { xPercent: 0.60, yPercent: 0.85, widthPercent: 0.35, heightPercent: 0.10 },
        priority: 80,
